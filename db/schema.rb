...
ActiveRecord::Schema.define(version: 20_151_119_181_039) do
  ...
  add_index 'refinery_authentication_devise_roles_users', %w(role_id user_id), name: 'refinery_roles_users_role_id_user_id', using: :btree
  add_index 'refinery_authentication_devise_roles_users', %w(user_id role_id), name: 'refinery_roles_users_user_id_role_id', using: :btree
  ...
  add_index 'refinery_authentication_devise_user_plugins', %w(user_id name), name: 'refinery_user_plugins_user_id_name', unique: true, using: :btree
  ...
  add_index 'seo_meta', %w(seo_meta_id seo_meta_type), name: 'id_type_index_on_seo_meta', using: :btree
end
